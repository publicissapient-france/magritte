...
def write_list_of_floats_to_file(list_of_floats, file_path, bottleneck_tensor_size):
...
def read_list_of_floats_from_file(file_path, bottleneck_tensor_size):
...
def get_random_cached_bottlenecks(sess, image_lists, how_many, category,
                                  bottleneck_dir, image_dir, jpeg_data_tensor, bottleneck_tensor,
...
def get_random_distorted_bottlenecks(
        ...
        distorted_image, resized_input_tensor, bottleneck_tensor, max_num_images_per_class):
...
def add_input_distortions(flip_left_right, random_crop, random_scale,
                          random_brightness, model_input_depth, model_input_width, model_input_height):
...
def add_final_training_ops(class_count, final_tensor_name, bottleneck_tensor, learning_rate, bottleneck_tensor_size):
